...
it('renders nested backgrounds, overflows to 4 pages, warns on exactly 2 unsupported declarations, hides display:none text and keeps accents', function () {
    ...
    // Exactamente 2 declaraciones CSS no soportadas: float y width:em. "p > span" parsea Y matchea
    ...
    // (ver p { line-height: 1.5 } arriba). M2-T2: width SÍ admite % ahora (LengthPercentage) — la
    // unidad "em" se usa aquí para seguir demostrando el warning discipline sobre unidades no
    // soportadas sin afectar la aritmética de paginación de este test (declaración descartada igual
    // que antes, sin efecto en el layout).
